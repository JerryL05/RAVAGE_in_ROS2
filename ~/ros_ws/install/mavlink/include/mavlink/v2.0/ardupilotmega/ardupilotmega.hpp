...
enum class COPTER_MODE
{
    ...
    TURTLE=28, /* TURTLE | */
    RATE_ACRO=29, /* RATE_ACRO | */
};

//! COPTER_MODE ENUM_END
constexpr auto COPTER_MODE_ENUM_END = 30;
...
#include "./mavlink_msg_named_value_string.hpp"
